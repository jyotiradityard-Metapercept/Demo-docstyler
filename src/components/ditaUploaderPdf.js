...
const DITAConversionForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5055/convert-pdf', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="max-w-xl mx-auto p-8 bg-white shadow-xl rounded-xl relative">
      <h2 className="text-3xl font-bold mb-6 text-center text-black-700">DITA to PDF Migration</h2>
